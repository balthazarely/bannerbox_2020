...
main.from("#container", 0.5, { opacity: 0 })
	.from('#logo', 0.75, { x: -logoDistanceLeft, ease: Power3.easeOut }, "logo-in")
	.from('#hopper', 0.75, { x: 155, ease: Back.easeOut.config(1.2) }, "logo-in")
	...
	.to('#hopper', 1, { x: 155, ease: Back.easeInOut.config(1.2) }, "text-1-out")

	.from('#header-2', 0.5, { opacity: 0, y: 3, ease: Power1.easeOut, delay: -.25 }, "text-2-in")
