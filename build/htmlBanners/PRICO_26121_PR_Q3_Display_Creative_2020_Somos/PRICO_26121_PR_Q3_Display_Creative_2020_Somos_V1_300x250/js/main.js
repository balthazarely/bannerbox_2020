...
frameOne.from("#logo", 0.75, { x: -logoDistanceX, ease: powerOut }, "logo-in")
    ...
    .from("#hopper", 0.75, { x: 250, ease: easeOut }, "logo-in")
    ...
    .to("#hopper", 0.5, { x: 250, ease: easeIn }, "subhead-out")
    .from("#remote", 0.50, { y: 140, ease: easeOutStrong }, "remote-in", "-=0.10")
    .from("#subhead-2", 0.5, { opacity: 0, y: 3, }, "remote-in")
    .from("#google-logo", 0.5, { opacity: 0, y: 3, }, "remote-in");
